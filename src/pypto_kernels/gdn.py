...
from ._boot import bootstrap, classify, compile_jit_kernel, launch_graph
from ._graph import gdn_state_update_graph, tiles_for
...
def state_update_status(
    ...
    return classify(
        gdn_state_update_graph(heads, key_dim, value_dim),
        tiles_for(heads, key_dim, value_dim),
    )
