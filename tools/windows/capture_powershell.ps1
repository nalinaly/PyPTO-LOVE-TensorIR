...
$marker = "/tmp/pypto-ps-capture-$nonce.done"
$inner = "/tmp/pypto-ps-capture-$nonce-inner.sh"
$outer = "/tmp/pypto-ps-capture-$nonce-outer.sh"
$uncRoot = "\\wsl.localhost\$Distro"
$markerWindows = "$uncRoot\tmp\pypto-ps-capture-$nonce.done"
$innerWindows = "$uncRoot\tmp\pypto-ps-capture-$nonce-inner.sh"
$outerWindows = "$uncRoot\tmp\pypto-ps-capture-$nonce-outer.sh"
